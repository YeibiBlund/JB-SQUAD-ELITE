...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const FORMATIONS = {
        ...
        '3-1-4-2': [
            { id: 'GK', pos: 'POR', x: 50, y: 92 },
            { id: 'DFC1', pos: 'DFC', x: 68, y: 78 }, { id: 'DFC2', pos: 'DFC', x: 50, y: 78 }, { id: 'DFC3', pos: 'DFC', x: 32, y: 78 },
            { id: 'MCD', pos: 'MCD', x: 50, y: 62 },
            { id: 'MD', pos: 'MD', x: 82, y: 44 }, { id: 'MC1', pos: 'MC', x: 65, y: 44 }, { id: 'MC2', pos: 'MC', x: 35, y: 44 }, { id: 'MI', pos: 'MI', x: 18, y: 44 },
            { id: 'DC1', pos: 'DC', x: 60, y: 16 }, { id: 'DC2', pos: 'DC', x: 40, y: 16 }
        ]
    };
